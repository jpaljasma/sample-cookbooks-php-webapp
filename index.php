...
for($j=0;$j<100000;$j++) { $v = ''; for($i=0;$i<20;$i++) { $v=base64_encode($v.$i.''); }}
...
<html>
	...
	<body>
		...
		<p><img width="400" height="175" alt="Testing loading the image from the server" src="images/img000.jpeg" /></p>
	</body>
</html>